...
public abstract class CursorRecyclerAdapter<VH extends RecyclerView.ViewHolder>
    ...
    @Override
    public VH onCreateViewHolder(@NotNull final ViewGroup parent, final int viewType) {
    ...
    public Cursor swapCursor(final Cursor newCursor) {
        ...
        LogUtils.d("test", "notifyDataSetChanged count=" + mCursor.getCount()
                + ", mDataValid=" + mDataValid);
        // notify data set changed when swap cursor
    ...
    protected void onContentChanged() {
        if (mAutoRequery && mCursor != null && !mCursor.isClosed()) {
            LogUtils.d(TAG, "Auto requerying " + mCursor + " due to update");
